...
assert.match(contextMenu, /LiquidGlassCard/);
assert.match(contextMenu, /ContextMenu\.Item/);
assert.doesNotMatch(contextMenu, /from "\.\/LiquidMenu"/);
assert.doesNotMatch(contextMenu, /closeAfterCommit/);
...
assert.match(dialog, /LiquidGlassCard/);
assert.match(dialog, /children/);
assert.doesNotMatch(dialog, /LiquidMenu/);
assert.doesNotMatch(dialog, /closeAfterCommit/);
const menubar = fs.readFileSync(path.join(assetRoot, "LiquidMenubar.tsx"), "utf8");
assert.match(menubar, /@radix-ui\/react-menubar/);
assert.match(menubar, /LiquidGlassCard/);
assert.match(menubar, /Menubar\.Item/);
