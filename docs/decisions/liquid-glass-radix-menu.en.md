...
This batch turns `LiquidMenubar` into a command bar: thin File/Edit titles open an action list; click runs the command and closes. No selected-row `LiquidMenu`. Mobile verification is deferred.
