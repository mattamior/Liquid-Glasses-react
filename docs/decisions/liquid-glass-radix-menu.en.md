...
This batch turns `LiquidPopover` into a glass bubble card: `children` only, no built-in `LiquidMenu`. Open/close, morph, and press squash stay. Mobile verification is deferred.
