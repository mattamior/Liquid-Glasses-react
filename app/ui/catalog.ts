...
/>`,
  ...
  },
  {
    slug: "liquid-select",
    title: "LiquidSelect",
    summary: "Form-like trigger that shows the selected label. Closes after commit.",
    usage: `<LiquidSelect items={items} value={value} onValueChange={setValue} placeholder="选择…" />`,
    props: [
      { name: "items", type: "LiquidMenuItem[]", defaultValue: "—", description: "Same entries as LiquidMenu." },
      { name: "value", type: "string", defaultValue: "uncontrolled", description: "Controlled selected value." },
      { name: "onValueChange", type: "(value: string) => void", defaultValue: "—", description: "Fires after commit, then the list closes." },
  ...
  },
  {
    slug: "liquid-popover",
    title: "LiquidPopover",
    summary: "Click trigger. Panel stays open after a selection until dismissed.",
    usage: `<LiquidPopover items={items} value={value} onValueChange={setValue} trigger="打开" />`,
    props: [
      { name: "items", type: "LiquidMenuItem[]", defaultValue: "—", description: "Same entries as LiquidMenu." },
      { name: "value", type: "string", defaultValue: "uncontrolled", description: "Controlled selected value." },
      { name: "onValueChange", type: "(value: string) => void", defaultValue: "—", description: "Fires after commit. Panel stays open." },
  ...
  },
  {
    slug: "liquid-dialog",
    title: "LiquidDialog",
    summary: "Modal overlay plus centered glass menu. Closes after commit or dismiss.",
    usage: `<LiquidDialog items={items} value={value} onValueChange={setValue} trigger="打开对话框" />`,
    props: [
      { name: "items", type: "LiquidMenuItem[]", defaultValue: "—", description: "Same entries as LiquidMenu." },
      { name: "value", type: "string", defaultValue: "uncontrolled", description: "Controlled selected value." },
      { name: "onValueChange", type: "(value: string) => void", defaultValue: "—", description: "Fires after commit, then the dialog closes." },
  ...
  },
  {
    slug: "liquid-menubar",
    title: "LiquidMenubar",
    summary: "Horizontal trigger row. Each trigger opens a glass menu.",
    ...
    props: [
      ...
      { name: "onValueChange", type: "(group: string, value: string) => void", defaultValue: "—", description: "Fires after commit; the open menu then closes." },
    ],
  },
];
